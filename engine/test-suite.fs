...
: run-arithmetic-tests                                      ( )
    ...
    44 load ( min               ) 75 load ( negate            )
    95 load ( */mod             ) 97 load ( mod               )
    cr                                                      ( )
;                                                    -->    ( )
(  ---------------------------------------------------------  )
(  Memory Access Tests                                        )
...
: run-stack-word-tests                                      ( )
    ...
    59 load ( swap              ) 60 load ( ?dup              )
    61 load ( >r r@ r>          ) 62 load ( depth             )
                                                            ( )
     cr                                                     ( )
;                                                           ( )
                                                     -->    ( )
...
: run-flow-control-tests                                    ( )
    ." Flow Control: " cr                                   ( )
                                                            ( )
    decimal                                                 ( )
    63 load ( begin until       ) 64 load ( begin while repeat)
    66 load ( do loop           ) 67 load ( do +loop          )
    71 load ( leave             ) 72 load ( j                 )
    73 load ( if else then      )                           ( )
                                                            ( )
                                                            ( )
    cr                                                      ( )
;                                                           ( )
...
(  Nucleus Double Number Tests                                )
                                                            ( )
: run-nucleus-double-number-tests                           ( )
...
(  Suite Control Functions                                    )
                                                            ( )
: run-all-tests                                             ( )
    decimal 80 load             ( run test harness tests      )
    run-comparator-tests                                    ( )
    run-logic-tests                                         ( )
    run-arithmetic-tests                                    ( )
    run-memory-access-tests                                 ( )
