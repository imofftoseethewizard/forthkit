...
define(`__evaluator_variable_declarations', 7)
define(`__discard_diversion', `divert(-1)undivert($1)divert')
define(`__discard_all_diversions', `divert(-1)undivert(1)undivert(2)undivert(3)undivert(4)undivert(5)undivert(6)undivert(7)divert')
