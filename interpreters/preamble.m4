...
pushdef(`__primitive_defs', `add_primitive_definition(&defs, $1, _from_pv($2));')dnl
pushdef(`__primitive_descs', `{$1, _from_pv($2)},')dnl
...
define(`__define_constant',`pushdef(`__constant_descs', `{$1, $2},')dnl')
